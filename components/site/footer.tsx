...
export function Footer() {
  return (
    <footer className="relative overflow-hidden border-t border-primary/20 bg-ink-gradient pt-16 text-foreground">
      ...
      <div className="container relative">
            ...
            <nav className="flex flex-col gap-2">
              {QUICK_LINKS.map((link) => (
                <a
                  key={link.name}
                  href={link.href}
                  className="group flex w-fit items-center gap-2 text-sm text-muted-foreground transition-colors hover:text-primary-light"
                >
          ...
          <RevealItem>
            ...
            <div className="space-y-3">
              <a
                ...
                className="flex items-center gap-2 text-sm text-muted-foreground transition-colors hover:text-primary-light"
              >
        ...
        <div className="flex flex-col items-center gap-2 border-t border-foreground/10 py-8 text-center sm:flex-row sm:justify-between sm:text-left">
      ...
      <span
        aria-hidden="true"
        className="pointer-events-none block select-none pb-2 text-center font-display text-[19vw] font-bold leading-none tracking-tight text-foreground/[0.05] sm:text-[16vw]"
      >
        WIPUP
      </span>
    </footer>
