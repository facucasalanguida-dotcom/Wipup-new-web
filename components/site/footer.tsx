...
export function Footer() {
  return (
    <footer className="relative overflow-hidden border-t border-primary-dark bg-ink-gradient pt-16 text-ink-foreground">
      <div className="absolute inset-0 bg-soft-dots opacity-60" aria-hidden="true" />
      <div
        className="pointer-events-none absolute -top-24 left-1/2 h-72 w-[40rem] -translate-x-1/2 rounded-full bg-primary-light/15 blur-3xl"
        aria-hidden="true"
      />
      <div className="container relative">
            ...
            <nav className="flex flex-col gap-2">
              {QUICK_LINKS.map((link) => (
                <a
                  key={link.name}
                  href={link.href}
                  className="group flex w-fit items-center gap-2 text-sm text-ink-foreground/65 transition-colors hover:text-primary-light"
                >
          ...
          <RevealItem>
            ...
            <div className="space-y-3">
              <a
                ...
                className="flex items-center gap-2 text-sm text-ink-foreground/65 transition-colors hover:text-primary-light"
              >
        ...
        <div className="flex flex-col items-center gap-2 border-t border-ink-foreground/15 py-8 text-center sm:flex-row sm:justify-between sm:text-left">
      ...
      <span
        aria-hidden="true"
        className="pointer-events-none block select-none pb-2 text-center font-display text-[19vw] font-bold leading-none tracking-tight text-ink-foreground/[0.07] sm:text-[16vw]"
      >
        WIPUP
      </span>
    </footer>
