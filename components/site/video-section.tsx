...
export function VideoSection() {
  return (
    <section id="videos" className="relative overflow-hidden bg-background py-20 lg:py-32">
      ...
      <div
        className="pointer-events-none absolute left-1/2 top-1/2 h-[34rem] w-[34rem] -translate-x-1/2 -translate-y-1/2 animate-blob rounded-full bg-accent-light/45 blur-3xl"
        aria-hidden="true"
      />
      ...
      <div className="container relative">
        <div className="mb-12 text-center">
          ...
          <Reveal>
            <h2 className="text-3xl font-bold text-foreground sm:text-4xl">
              Nuestros productos <span className="text-gradient-fresh">en video</span>
            </h2>
          </Reveal>
        </div>
        ...
        <div className="flex justify-center">
          <Reveal variants={scaleIn} className="relative">
            ...
            >
              <div className="absolute left-1/2 top-3 z-10 h-1.5 w-16 -translate-x-1/2 rounded-full bg-ink-foreground/25" />
            ...
            <motion.div
              ...
              className="absolute -top-5 left-1/2 flex items-center gap-2 rounded-full glass px-4 py-2 text-sm font-semibold text-foreground shadow-card"
            >
            ...
            <motion.div
              ...
              className="absolute -bottom-4 -right-6 hidden items-center gap-2 rounded-2xl bg-accent px-4 py-3 text-sm font-bold text-accent-foreground shadow-card sm:flex"
            >
