    ...
    <section id="videos" className="relative overflow-hidden bg-secondary/40 py-20 lg:py-32">
      ...
      <div className="container relative">
        <Reveal className="mb-12 text-center">
          <span className="font-semibold text-primary">Mirá WIPuP en acción</span>
          <h2 className="mt-2 text-3xl font-bold text-ink sm:text-4xl">Nuestros productos en video</h2>
        </Reveal>
