    ...
    <section id="experiencia" className="relative overflow-hidden bg-background py-20 lg:py-32">
      ...
      <div className="container relative">
        <Reveal variants={slideInLeft}>
          <Card className="relative h-[600px] w-full overflow-hidden border border-border bg-card shadow-card sm:h-[500px]">
            <div
              className="pointer-events-none absolute -left-20 -top-20 h-72 w-72 animate-blob rounded-full bg-accent-light/50 blur-3xl"
              aria-hidden="true"
            />

            <div className="flex h-full flex-col lg:flex-row">
              <div className="relative z-10 flex flex-1 flex-col justify-center p-8 lg:p-12">
                <EditorialBadge index="N°05" label="Experiencia WIPuP" className="mb-6" />
                ...
                <div className="mt-8">
                  <Magnetic strength={0.25}>
                    <Button variant="hero" size="lg" asChild className="shadow-soft">
                      <a href="#productos">
                        Descubrir productos
